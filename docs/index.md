...
!!! info
    ...
    **Source Code Repository:** [https://github.com/ai-rolling-demo/test-tpetkos-chatbot1](https://github.com/ai-rolling-demo/test-tpetkos-chatbot1)

    **GitOps Repository:** [https://github.com/ai-rolling-demo/test-tpetkos-chatbot1-gitops](https://github.com/ai-rolling-demo/test-tpetkos-chatbot1-gitops)

# **Usage**

To access the test-tpetkos-chatbot1 application that was deployed using the Software Template, complete the following instructions:
